# nvim-treesitter-queries-udev

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-udev/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-udev/actions/workflows/validate.yml)

Neovim tree-sitter queries for **udev**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-udev",
...
- [ ] Changes are scoped to `udev` — do not include files for other languages
